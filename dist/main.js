...
import { Point, Spring, Gravity } from "./model.js";
import { Render2 } from "./render.js";
const modelName = sessionStorage.getItem("physicalsimu_model") ?
...
if (modelName == "wave") { // 平面波
    ...
    function net() {
        ...
        Points[numy * 2 / 5 * numx].updatePosition = (t) => { Points[numy * 2 / 5 * numx].r.x = Math.sin(t * 0.5) * 50; };
        Points[numy * 3 / 5 * numx].updatePosition = (t) => { Points[numy * 3 / 5 * numx].r.x = Math.sin(t * 0.5) * 50; };
